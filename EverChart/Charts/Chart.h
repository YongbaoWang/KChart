...
@property (nonatomic)        int   rangeTo; //显示结束下标
...
@property (nonatomic)        int candleIndex; //蜡烛图：0日k；1周k；2月k
 ...
 *  蜡烛图 切换 block
 */
@property (copy, nonatomic) void(^candleBlock)();

/**
 *  成交量 切换 block
 */
@property (copy, nonatomic) void(^volumeBlock)();
